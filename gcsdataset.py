...
class ImageFolder(VisionDataset):
    def __init__(
      ...
      if paths is None:         
          ...
          paths = list(torch_xla._XLAC._xla_tffs_list(os.path.join(self.root, "*", "*.JPEG"))) # pytype: disable=module-attr
          paths.sort()
      samples, classes_to_idx = make_dataset(self.root, paths, torchvision.datasets.folder.IMG_EXTENSIONS)  # pytype: disable=module-attr
